...
App.Bac = (() => {
  ...
  const CBPH_QUESTIONS = [
    {
      ...
      questions: [
        { pts: 3, texte: '1. En vous appuyant sur le document 1, expliquez le mécanisme immunitaire à l\'origine des lésions intestinales. Précisez le rôle de chaque type de lymphocyte impliqué.' },
    ...
    },
    {
      ...
      dossier: [
        ...
        { id: 'Document 1', titre: 'Mécanismes de la cancérogenèse colorectale',
          texte: 'Le cancer colorectal résulte de l\'accumulation de mutations dans des gènes clés : mutation du gène APC (gène suppresseur de tumeur), activation de l\'oncogène KRAS, mutation de TP53 (perte de l\'apoptose). Ces mutations s\'accumulent sur plusieurs années : muqueuse normale → adénome → carcinome in situ → cancer invasif.' },
        { id: 'Document 2', titre: 'Facteurs de risque du cancer colorectal',
          texte: 'Facteurs non modifiables : âge > 50 ans, antécédents familiaux (syndrome de Lynch, PAF), maladies inflammatoires chroniques (MICI). Facteurs modifiables : alimentation riche en viandes rouges et charcuteries, faible consommation de fibres, sédentarité, obésité, tabagisme, alcool. Les fibres alimentaires protègent en réduisant le temps de transit et la concentration des carcinogènes dans le côlon.' }
      ],
      questions: [
        ...
        { pts: 4, texte: '2. À partir du document 2 et de vos connaissances, classez les facteurs de risque en modifiables et non modifiables. Expliquez comment l\'alimentation peut à la fois augmenter et diminuer le risque.' },
        { pts: 3, texte: '3. Justifiez l\'intérêt du dépistage organisé du cancer colorectal. Expliquez pourquoi le dépistage précoce améliore significativement le pronostic.' }
      ]
    },
    {
      ...
      dossier: [
        { id: 'Texte introductif', titre: 'La démence à corps de Lewy',
          texte: 'La démence à corps de Lewy (DCL) est la 2e cause de démence neurodégénérative après la maladie d\'Alzheimer. Elle est caractérisée par des dépôts anormaux d\'alpha-synucléine dans les neurones dopaminergiques du locus niger (corps de Lewy). Elle associe des troubles cognitifs, des symptômes parkinsoniens et des hallucinations visuelles. Le traitement repose notamment sur la L-dopa (précurseur de la dopamine).' },
      ...
      questions: [
        ...
        { pts: 3, texte: '3. La L-dopa est utilisée dans le traitement de la DCL. Expliquez son mécanisme d\'action et justifiez pourquoi on administre la L-dopa plutôt que directement la dopamine.' }
      ]
    },
    {
      ...
      dossier: [
        ...
        { id: 'Document 2', titre: 'Cancer du col de l\'utérus et HPV',
          texte: 'Le cancer du col de l\'utérus est causé dans 99 % des cas par une infection persistante aux Papillomavirus humains (HPV). Les souches HPV 16 et 18 sont responsables de 70 % des cancers. La vaccination (Gardasil) est recommandée dès 11 ans. Le dépistage par frottis cervico-utérin (FCU) est recommandé tous les 3 ans entre 25 et 65 ans.' }
      ],
      questions: [
        ...
        { pts: 3, texte: '3. Le délai de diagnostic de l\'endométriose est en moyenne de 7 ans. Identifiez les obstacles au diagnostic précoce et proposez des pistes d\'amélioration.' }
      ]
    },
    {
      ...
      dossier: [
        ...
        { id: 'Document 1', titre: 'Principe de la thérapie génique ex vivo',
          texte: 'Étapes : 1. Prélèvement de cellules souches hématopoïétiques (CSH) du patient. 2. Transduction ex vivo : introduction du gène thérapeutique dans les CSH via un vecteur lentiviral. 3. Conditionnement du patient par chimiothérapie. 4. Réinjection des CSH corrigées par voie intraveineuse. 5. Reconstitution de la moelle osseuse saine. Efficacité démontrée dans la bêta-thalassémie, le SCID-X1 et l\'adrénoleucodystrophie.' },
        { id: 'Document 2', titre: 'Enjeux éthiques et économiques des biothérapies',
          texte: 'Le coût des biothérapies est considérable : Zolgensma (traitement de l\'amyotrophie spinale) coûte 2 millions d\'euros par injection. Ces traitements soulèvent des questions d\'équité d\'accès aux soins. En France, la prise en charge par l\'Assurance Maladie fait l\'objet de négociations avec les laboratoires. La thérapie génique soulève également des questions éthiques : risque d\'intégration dans les cellules germinales, effets à long terme inconnus.' }
      ],
      questions: [
    ...
    },
    {
      ...
      dossier: [
        ...
        { id: 'Document 2', titre: 'Prise en charge de l\'insuffisance rénale chronique (IRC)',
          texte: 'L\'IRC évolue en 5 stades selon le débit de filtration glomérulaire (DFG) : Stade 1 DFG ≥ 90 mL/min (normal), Stade 3 DFG 30–60 (modéré), Stade 5 DFG < 15 mL/min (terminal). Au stade terminal : dialyse (hémodialyse ou dialyse péritonéale) ou transplantation rénale. La transplantation offre la meilleure qualité de vie. En 2022, 4 468 greffes rénales ont été réalisées en France, les listes d\'attente dépassant 5 ans.' }
      ],
      questions: [
        ...
        { pts: 4, texte: '2. À partir du document 2 et de vos connaissances, présentez les options de traitement de l\'insuffisance rénale terminale. Comparez dialyse et transplantation en termes d\'efficacité, de contraintes et d\'impact sur la qualité de vie.' },
    ...
    },
    {
      ...
      dossier: [
        { id: 'Texte introductif', titre: 'Le mélanome malin',
          texte: 'Le mélanome est un cancer de la peau développé à partir des mélanocytes. Son incidence augmente régulièrement (+4 %/an en France). Il représente seulement 10 % des cancers cutanés mais est responsable de 80 % des décès par cancer de la peau. L\'exposition aux UV (soleil, cabines UV) est le principal facteur de risque. Détecté tôt, le pronostic est excellent (survie à 5 ans > 95 %).' },
        { id: 'Document 1', titre: 'Mécanismes de la cancérogenèse du mélanome',
          texte: 'Les rayonnements UV induisent des mutations dans l\'ADN des mélanocytes, notamment dans le gène BRAF (mutation V600E dans 50 % des mélanomes) qui active la voie de signalisation de la prolifération cellulaire. Les UV provoquent également une immunosuppression locale, favorisant l\'échappement tumoral. Les phototypes clairs sont plus sensibles car leur mélanine est moins photoprotectrice.' },
        { id: 'Document 2', titre: 'Nouvelles thérapies ciblées du mélanome métastatique',
          texte: 'Les thérapies ciblées (inhibiteurs BRAF : vemurafenib, dabrafenib) et l\'immunothérapie (inhibiteurs de points de contrôle : nivolumab, pembrolizumab) ont révolutionné le traitement. L\'immunothérapie relance la réponse immunitaire anti-tumorale en bloquant les protéines PD-1/PD-L1 qui permettent aux cellules tumorales d\'échapper aux lymphocytes T cytotoxiques. Survie à 5 ans avec immunothérapie : 40–50 % vs moins de 10 % avant ces traitements.' }
      ],
      questions: [
    ...
    },
    {
      ...
      dossier: [
        ...
        { id: 'Document 2', titre: 'Prise en charge de l\'obésité',
          texte: 'Prise en charge pluridisciplinaire et progressive : 1. Mesures hygiéno-diététiques : rééquilibrage alimentaire, activité physique (30 min/jour). 2. Accompagnement psychologique : TCC. 3. Traitements médicamenteux : orlistat. 4. Chirurgie bariatrique (bypass gastrique, sleeve gastrectomie) : indiquée si IMC > 40 ou > 35 avec comorbidités, après échec de 12 mois de prise en charge pluridisciplinaire. Objectif : perte de 10 % du poids initial améliore significativement les comorbidités.' }
      ],
      questions: [
  ...
  const STSS_QUESTIONS = {
      ...
      },
      {
        ...
        dossier: [
          { id: 'Document 1', titre: 'Les prestations familiales en France (CAF, 2023)',
            texte: 'Allocations familiales : versées dès le 2e enfant, modulées selon les revenus depuis 2015. Prestation d\'Accueil du Jeune Enfant (PAJE) : prime à la naissance (946 euros), allocation de base (184 euros/mois jusqu\'aux 3 ans), Complément Mode de Garde (CMG). Congé parental d\'éducation (CPE) : 3 ans maximum par parent, indemnisé via la PreParE (396 euros/mois pour le 1er enfant). Total dépenses branche famille : 51 milliards d\'euros en 2022.' },
    ...
    offre_soins: [
      {
        ...
        dossier: [
          { id: 'Document 1', titre: 'Les niveaux de recours aux soins',
            texte: 'Soins primaires (1er recours) : médecin généraliste, infirmier, pharmacien, kinésithérapeute. Rôle de coordination et de prévention. Le médecin traitant est le pivot du parcours de soins coordonné. Soins secondaires (2e recours) : spécialistes (sur orientation), hospitalisation programmée. Soins tertiaires (3e recours) : CHU, soins très spécialisés (réanimation, greffes, cancérologie). Soins de proximité : HAD, SSIAD, EHPAD.' },
          { id: 'Document 2', titre: 'Les déserts médicaux en France (DREES, 2023)',
            texte: 'Définition : zone caractérisée par une accessibilité potentielle localisée (APL) à un médecin généraliste inférieure à 2,5 consultations par habitant et par an. 11 % de la population française vit dans un désert médical (6,5 millions de personnes). Moyennes : 133 généralistes pour 100 000 hab. en zones rurales vs 198 en zones urbaines. Conséquences : recours plus tardif aux soins, aggravation des pathologies chroniques, surcharge des urgences (+5 %/an).' }
        ],
        questions: [
          { pts: 4, texte: '1. À partir du document 1 et de vos connaissances, présentez les différents niveaux de recours aux soins en France. Quel est le rôle du médecin traitant dans le parcours de soins coordonné ?' },
          { pts: 4, texte: '2. En vous appuyant sur le document 2 et vos connaissances, analysez le phénomène des déserts médicaux en France. Quelles sont les causes et les conséquences sur la santé des populations concernées ?' },
          { pts: 4, texte: '3. Proposez et justifiez des mesures permettant de lutter contre les inégalités d\'accès aux soins en France. À quel niveau d\'intervention (individuel, professionnel, structurel) se situent ces mesures ?' }
        ]
      },
      {
        annee: 'Sujet type', theme: 'Prévention et promotion de la santé', isReal: false,
        intro: 'La santé publique moderne repose sur trois piliers : la prévention, la promotion de la santé et l\'éducation pour la santé. Ces approches complémentaires visent à agir en amont de la maladie pour améliorer l\'état de santé de la population dans sa globalité.',
        dossier: [
          { id: 'Document 1', titre: 'Les niveaux de prévention (OMS)',
            texte: 'Prévention primaire : éviter l\'apparition de la maladie (vaccination, éducation à la santé, actions sur les déterminants). Prévention secondaire : dépistage précoce et traitement rapide (dépistage du cancer, dépistage néonatal). Prévention tertiaire : limiter les complications et les rechutes chez les personnes malades (réhabilitation, éducation thérapeutique du patient - ETP). Prévention quaternaire : prévenir la surmédicalisation et les effets iatrogènes.' },
          { id: 'Document 2', titre: 'La stratégie nationale de santé 2018–2022',
            texte: 'La Stratégie Nationale de Santé repose sur 4 axes : 1. Mettre en place une politique de promotion de la santé (notamment à l\'école) ; 2. Lutter contre les inégalités sociales et territoriales de santé ; 3. Renforcer la pertinence et la qualité du système de santé ; 4. Innover pour transformer le système de santé. Elle mobilise les déterminants de santé : comportements, conditions de vie, accès aux soins, facteurs biologiques.' }
        ],
        questions: [
          { pts: 4, texte: '1. À partir du document 1 et de vos connaissances, distinguez les différents niveaux de prévention en illustrant chacun par un exemple concret.' },
          { pts: 4, texte: '2. En vous appuyant sur le document 2 et vos connaissances, présentez les principaux axes de la politique de santé publique en France. Comment agit-elle sur les déterminants de la santé ?' },
    ...
    protection: [
      {
        annee: 'Polynésie 2024', theme: 'La protection sociale face aux risques sociaux', isReal: false,
        ...
        dossier: [
          { id: 'Document 1', titre: 'Les risques couverts par la protection sociale',
            texte: 'La protection sociale couvre 9 risques définis par le Conseil National de l\'Information Statistique : maladie, maternité-paternité, invalidité, accidents du travail-maladies professionnelles, vieillesse, famille, chômage, logement, pauvreté-exclusion sociale. En 2022, les dépenses totales de protection sociale représentent 34,4 % du PIB français. La branche maladie représente le poste le plus important (38 % des prestations).' },
          { id: 'Document 2', titre: 'Les modes de financement de la protection sociale',
            texte: 'Deux grands principes coexistent : le principe bismarckien (cotisations sociales proportionnelles aux salaires, droits liés au travail) et le principe beveridgien (financement fiscal universel, droits liés à la citoyenneté). La France a un système mixte. La CSG (Contribution Sociale Généralisée), créée en 1991 et élargie en 1997, est une cotisation prélevée sur tous les revenus (travail, capital, remplacement) et constitue désormais la principale ressource de la Sécurité Sociale.' }
        ],
        questions: [
          { pts: 4, texte: '1. À partir du document 1 et de vos connaissances, définissez la notion de risque social et présentez les principaux risques couverts par la protection sociale française.' },
          { pts: 4, texte: '2. En vous appuyant sur le document 2 et vos connaissances, distinguez les principes bismarckien et beveridgien de financement de la protection sociale. Comment le système français articule-t-il ces deux logiques ?' },
      ...
      },
      {
        ...
        dossier: [
          { id: 'Document 1', titre: 'Le ticket modérateur et les restes à charge',
            texte: 'L\'Assurance Maladie ne rembourse pas intégralement les soins. Le ticket modérateur est la part laissée à la charge de l\'assuré (par ex. 30 % pour une consultation chez un généraliste). Pour limiter le renoncement aux soins, des dispositifs existent : Affection de Longue Durée (ALD) : prise en charge à 100 % pour 30 maladies chroniques. Complémentaire santé solidaire (CSS) : ex-CMU-C, pour les personnes aux revenus modestes. Franchise médicale : 50 centimes par boîte de médicament plafonnée à 50 euros/an.' },
          { id: 'Document 2', titre: 'Le déficit de l\'Assurance Maladie et les réformes',
            texte: 'Le déficit de la branche maladie de la Sécurité Sociale atteint 7,7 milliards d\'euros en 2023. Les principales causes : vieillissement de la population, développement des maladies chroniques, coût des nouvelles technologies médicales, fraudes (estimées à 3–6 milliards d\'euros/an). Réformes engagées : développement des génériques (46 % des médicaments remboursés en 2023), virage ambulatoire, pertinence des soins, lutte contre la fraude.' }
        ],
        questions: [
          { pts: 4, texte: '1. À partir du document 1 et de vos connaissances, expliquez le mécanisme du ticket modérateur. Pourquoi des dispositifs de protection complémentaire ont-ils été mis en place ? Quels sont leurs enjeux en termes d\'équité ?' },
          { pts: 4, texte: '2. En vous appuyant sur le document 2 et vos connaissances, analysez les causes du déficit chronique de l\'Assurance Maladie. Quelles réformes peuvent permettre d\'améliorer l\'équilibre financier de la branche maladie ?' },
          { pts: 4, texte: '3. L\'Assurance Maladie repose sur le principe de solidarité. Comment ce principe se traduit-il concrètement dans le fonctionnement du système ? Quelles tensions existent entre solidarité et responsabilité individuelle ?' }
        ]
      }
    ],
    ...
    politique_sp: [
      {
        ...
        dossier: [
          { id: 'Document 1', titre: 'Le PNNS 4 (2019–2023)',
            texte: 'Le 4e PNNS articule ses objectifs autour de 3 axes : 1. Améliorer l\'alimentation et l\'activité physique pour tous ; 2. Adapter les actions aux populations vulnérables (enfants, personnes précaires) ; 3. Créer des environnements favorables à la santé. Actions concrètes : Nutri-Score obligatoire sur les emballages, réduction du sel, du sucre et des graisses saturées dans les aliments transformés, lutte contre la sédentarité, développement des filières fruits et légumes accessibles.' },
          { id: 'Document 2', titre: 'Impact des politiques nutritionnelles : résultats et limites',
            texte: 'Depuis le premier PNNS, la consommation de fruits et légumes a légèrement augmenté et celle de sel diminué. Cependant, l\'obésité continue de progresser (17 % en 2023 vs 8 % en 1997). Inégalités sociales : les enfants de milieux défavorisés ont 2,5 fois plus de risque d\'obésité que les enfants de cadres. Limites des politiques nutritionnelles : efficacité limitée sur les comportements individuels, nécessité d\'agir sur les déterminants structurels (prix des aliments sains, déserts alimentaires, stress).' }
        ],
        questions: [
          { pts: 4, texte: '1. À partir du document 1 et de vos connaissances, présentez les principaux objectifs et actions du PNNS 4. À quel niveau de prévention ces actions se situent-elles ?' },
          { pts: 4, texte: '2. En vous appuyant sur le document 2 et vos connaissances, évaluez l\'efficacité des politiques nutritionnelles en France. Comment expliquer les inégalités sociales face à l\'obésité ?' },
          { pts: 4, texte: '3. Quelle place pour la responsabilité individuelle dans la prévention de l\'obésité ? Faut-il mettre davantage l\'accent sur les politiques structurelles (taxation, publicité alimentaire, environnement) ? Développez une argumentation équilibrée.' }
        ]
      },
      {
        annee: 'Sujet type', theme: 'Les politiques de lutte contre les addictions', isReal: false,
        intro: 'Les conduites addictives (tabac, alcool, drogues illicites, addictions comportementales) constituent un enjeu majeur de santé publique en France. Le Plan National de Mobilisation contre les Addictions 2018–2022 (PNMA) vise à réduire la consommation et ses conséquences sanitaires et sociales.',
        dossier: [
          { id: 'Document 1', titre: 'Épidémiologie des addictions en France (OFDT, 2023)',
            texte: 'Tabac : 25 % des Français fumeurs quotidiens (premier facteur de mortalité évitable : 75 000 décès/an). Alcool : 2e cause de mortalité évitable (41 000 décès/an), 11,4 % de la population adulte a une consommation à risque. Cannabis : 5 millions d\'usagers dans l\'année, 900 000 usagers quotidiens. Addictions comportementales (jeux, écrans) : en forte progression chez les jeunes. Coût social global des addictions : 180 milliards d\'euros/an.' },
          { id: 'Document 2', titre: 'Les outils de la politique de lutte contre les addictions',
            texte: 'Prévention primaire : programmes scolaires, campagnes d\'information (Moi(s) sans tabac, Dry January), réglementation de la publicité. Réduction des risques (RdR) : salles de consommation à moindre risque (SCMR), programmes d\'échange de seringues, mise à disposition de naloxone (antidote aux opioïdes). Traitement : consultations en addictologie, centres de soins d\'accompagnement et de prévention en addictologie (CSAPA), substitution (méthadone, buprénorphine). Mesures fiscales : taxes sur le tabac et l\'alcool.' }
        ],
        questions: [
          { pts: 4, texte: '1. À partir du document 1 et de vos connaissances, analysez l\'ampleur des conduites addictives en France et leurs conséquences sanitaires et sociales.' },
          { pts: 4, texte: '2. En vous appuyant sur le document 2 et vos connaissances, présentez les différentes stratégies de lutte contre les addictions. Distinguez les approches d\'abstinence et de réduction des risques.' },
    ...
    inegalites: [
      {
        annee: 'Métropole Remplacement 2024', theme: 'Les inégalités sociales de santé (ISS)', isReal: false,
        intro: 'En France, l\'espérance de vie à la naissance est de 85,7 ans pour les femmes et 79,4 ans pour les hommes (2023). Mais derrière ces moyennes se cachent de profondes inégalités sociales, territoriales et de genre qui interrogent les principes d\'équité et les politiques de santé publique.',
        dossier: [
          { id: 'Document 1', titre: 'Le gradient social de santé (HCSP, 2022)',
            texte: 'Le gradient social de santé désigne la relation progressive entre le statut socioéconomique et l\'état de santé : plus le niveau social est élevé, meilleur est l\'état de santé. En France : l\'espérance de vie des cadres supérieurs à 35 ans est de 6 ans supérieure à celle des ouvriers pour les hommes. La mortalité prématurée est 3 fois plus élevée chez les sans-diplôme que chez les diplômés du supérieur. Les déterminants : conditions de vie et de travail, accès aux soins, comportements de santé, facteurs psychosociaux (stress, sentiment de contrôle).' },
          { id: 'Document 2', titre: 'Les inégalités territoriales de santé',
            texte: 'L\'espérance de vie varie de 3 ans entre les régions françaises (Bretagne vs Hauts-de-France). Les zones rurales sont touchées par les déserts médicaux mais aussi par des comportements à risque (alcool, tabac) plus fréquents. Les QPV (Quartiers Prioritaires de la politique de la Ville) cumulent les facteurs de risque : chômage, précarité, logements insalubres, pollution, accès limité aux soins. La Covid-19 a révélé et aggravé ces inégalités territoriales.' }
        ],
        questions: [
          { pts: 4, texte: '1. À partir du document 1 et de vos connaissances, expliquez le concept de gradient social de santé. Quels sont les principaux déterminants sociaux qui expliquent ces inégalités ?' },
          { pts: 4, texte: '2. En vous appuyant sur le document 2 et vos connaissances, analysez les inégalités territoriales de santé en France. Comment les quartiers prioritaires et les zones rurales sont-ils spécifiquement touchés ?' },
    ...
    vieillissement: [
      {
        annee: 'Sujet type 2023', theme: 'Vieillissement de la population et autonomie des personnes âgées', isReal: false,
        intro: 'La France vieillit : en 2050, une personne sur quatre sera âgée de plus de 65 ans. Ce phénomène démographique sans précédent pose des défis majeurs en termes de prise en charge, de financement et d\'organisation du système de santé et médico-social.',
        dossier: [
          { id: 'Document 1', titre: 'Le vieillissement en France : données démographiques (INSEE, 2023)',
            texte: 'En 2023, la France compte 13,7 millions de personnes de plus de 65 ans (20 % de la population). En 2050, cette proportion passera à 26,5 %. Le nombre de personnes dépendantes passerait de 1,4 million en 2020 à 2,5 millions en 2050 selon les projections de la DREES. Les plus de 85 ans (les "grands vieillards") représentent la classe d\'âge à la croissance la plus rapide. La maladie d\'Alzheimer et les maladies apparentées touchent 900 000 personnes et constituent la première cause de dépendance.' },
          { id: 'Document 2', titre: 'L\'APA (Allocation Personnalisée d\'Autonomie) et la grille AGGIR',
            texte: 'L\'APA est une allocation attribuée aux personnes âgées dépendantes de plus de 60 ans (GIR 1 à 4). La grille AGGIR (Autonomie Gérontologique Groupes Iso-Ressources) évalue le niveau de dépendance selon 17 variables (toilette, habillage, alimentation, déplacements, cohérence...). GIR 1 et 2 : dépendance totale ; GIR 3 et 4 : dépendance partielle ; GIR 5 et 6 : personnes autonomes. L\'APA à domicile permet de financer un plan d\'aide (auxiliaire de vie, portage repas, téléassistance). L\'APA en établissement finance une partie du tarif dépendance en EHPAD.' }
        ],
        questions: [
          { pts: 4, texte: '1. À partir du document 1 et de vos connaissances, présentez les grandes tendances du vieillissement démographique en France et ses conséquences sur le système de santé et de protection sociale.' },
          { pts: 4, texte: '2. En vous appuyant sur le document 2 et vos connaissances, expliquez le fonctionnement de l\'APA. Comment la grille AGGIR permet-elle d\'objectiver le niveau de dépendance et d\'adapter la prise en charge ?' },
          { pts: 4, texte: '3. Le maintien à domicile est une priorité des politiques gérontologiques. Quelles sont les conditions nécessaires à sa réussite ? Quelles sont les limites de cette approche et quand l\'entrée en EHPAD devient-elle nécessaire ?' }
        ]
      }
    ],
    ...
    sante_mentale: [
      {
        annee: 'Métropole 2025', theme: 'La santé mentale : un enjeu de société', isReal: false,
        intro: 'La santé mentale est définie par l\'OMS comme "un état de bien-être dans lequel une personne peut se réaliser, surmonter les tensions normales de la vie, accomplir un travail productif et contribuer à la vie de sa communauté." En France, les troubles psychiatriques touchent 13 millions de personnes, soit 20 % de la population.',
        dossier: [
          { id: 'Document 1', titre: 'Épidémiologie des troubles de santé mentale en France (SPF, 2023)',
            texte: 'Prévalence sur la vie entière : dépression 15 %, troubles anxieux 17 %, schizophrénie 1 %, troubles bipolaires 2 %, troubles addictifs (inclus). Les troubles psychiatriques représentent la 1ère cause d\'invalidité professionnelle et la 2e cause d\'arrêt maladie longue durée. La Covid-19 a entraîné une hausse de 20 % des épisodes dépressifs et une multiplication par 2 des idées suicidaires chez les 15–24 ans. En France : 9 000 décès par suicide par an (1er cause de mort chez les 25–34 ans).' },
          { id: 'Document 2', titre: 'La psychiatrie de secteur et la désinstitutionnalisation',
            texte: 'La loi du 31 décembre 1985 a instauré la "psychiatrie de secteur" en France : chaque territoire est divisé en secteurs géographiques dotés d\'équipes soignantes pluridisciplinaires (psychiatre, infirmier, psychologue, assistante sociale). L\'objectif est le maintien dans la communauté et la prévention de l\'hospitalisation (ambulatoire, hôpital de jour, CMP - Centres Médico-Psychologiques). La France a réduit de moitié le nombre de lits psychiatriques depuis 1980, sans toujours développer suffisamment les structures ambulatoires de substitution.' }
        ],
        questions: [
          { pts: 4, texte: '1. À partir du document 1 et de vos connaissances, dressez un état des lieux de la santé mentale en France. Quels groupes de population sont particulièrement vulnérables et pourquoi ?' },
          { pts: 4, texte: '2. En vous appuyant sur le document 2 et vos connaissances, expliquez le principe de la psychiatrie de secteur et les objectifs de la désinstitutionnalisation. Quelles limites cette politique a-t-elle rencontrées ?' },
          { pts: 4, texte: '3. Comment améliorer la prise en charge de la santé mentale en France ? Discutez les rôles respectifs de la prévention, du soin et de l\'inclusion sociale. Quelle place pour la réhabilitation psychosociale ?' }
        ]
      }
    ],
    ...
    pauvrete: [
      {
        annee: 'Centres Étrangers 2024', theme: 'Pauvreté, exclusion sociale et RSA', isReal: false,
        ...
        dossier: [
          { id: 'Document 1', titre: 'Mesure et formes de la pauvreté (INSEE, 2023)',
            texte: 'Taux de pauvreté monétaire : 14,4 % de la population française. Groupes les plus touchés : les enfants (20,7 % de pauvreté), les familles monoparentales (36 %), les jeunes de 18–24 ans (20 %), les personnes nées hors UE (42 %). Pauvreté en conditions de vie (PCV) : difficultés concrètes sur 9 postes : alimentation, vêtement, logement, soins de santé, loisirs... La grande pauvreté (sans-abri, sans domicile fixe) touche 330 000 personnes en France, dont 42 000 dans la rue (Fondation Abbé Pierre, 2023).' },
          { id: 'Document 2', titre: 'Le RSA : bilan et perspectives (DREES, 2023)',
            texte: 'Le Revenu de Solidarité Active (RSA) a été créé par la loi du 1er décembre 2008. Montant : 607 euros pour une personne seule (2023). Bénéficiaires : 1,85 million de foyers. Objectifs : garantir un minimum de ressources ET favoriser l\'insertion professionnelle (droits et devoirs). Bilan : efficace pour sortir de la grande pauvreté, mais trappe à pauvreté possible. En 2023, le taux de non-recours au RSA est estimé à 34 %, soit 600 000 foyers potentiellement éligibles ne percevant pas la prestation. Réforme France Travail (2024) : renforcement de l\'accompagnement vers l\'emploi et obligation de 15–20h d\'activité par semaine.' }
        ],
        questions: [
          { pts: 4, texte: '1. À partir du document 1 et de vos connaissances, analysez les différentes dimensions de la pauvreté en France. Quels groupes sociaux sont les plus vulnérables et pour quelles raisons ?' },
          { pts: 4, texte: '2. En vous appuyant sur le document 2 et vos connaissances, présentez le fonctionnement du RSA. Quels sont ses atouts et ses limites ? Comment le non-recours affecte-t-il son efficacité ?' },
  ...
  function switchSubject(s) {
    ...
    // Chapitres visibles uniquement pour STSS
    const chapRow = document.getElementById('bac-chap-row');
  ...
  function switchChap(c) {
    stssChap = c; qIdx = 0;
    document.querySelectorAll('.bac-chap-btn').forEach(b => {
      const chap = STSS_CHAPITRES.find(ch => ch.label === b.textContent);
      b.classList.toggle('active', chap && chap.id === c);
    });
    _resetTimer();
    _render();
  }
  ...
  function _render() {
    ...
    // Compteur
    const counter = document.getElementById('bac-q-counter');
    if (counter) counter.textContent = bank.length > 0 ? (qIdx + 1) + ' / ' + bank.length : '—';

    // Badge sujet
    const badge = document.getElementById('bac-subj-badge');
    if (badge) {
      if (subj === 'stss' && q) {
        const chap = STSS_CHAPITRES.find(ch => ch.id === stssChap);
        const chapLabel = chap ? chap.label : '';
        const realTag = (q.isReal === true) ? ' · Annale réelle' : ' · Sujet type';
        badge.textContent = chapLabel + realTag;
        badge.className = 'bac-badge bac-badge-stss';
      } else if (subj === 'cbph') {
        badge.textContent = 'CBPH';
        badge.className = 'bac-badge bac-badge-cbph';
      }
    }

    if (!q) {
      document.getElementById('bac-dossier').innerHTML = '<p style="color:var(--gray-400);padding:20px 0">Aucun sujet disponible.</p>';
      document.getElementById('bac-questions').innerHTML = '';
      return;
    }

    // ── Dossier ──
    const dossierEl = document.getElementById('bac-dossier');
    let dHtml = '<div class="bac-dossier-title">' +
      '📄 ' + q.annee + ' — ' + escHtml(q.theme) +
      '</div>';
    if (q.intro) {
      dHtml += '<div class="bac-intro">' + escHtml(q.intro).replace(/\n/g, '<br>') + '</div>';
    }
    (q.dossier || []).forEach(doc => {
      dHtml += '<div class="bac-doc">' +
        '<strong>' + escHtml(doc.id) + (doc.titre ? ' — ' + escHtml(doc.titre) : '') + '</strong>' +
        '<p>' + escHtml(doc.texte).replace(/\n/g, '<br>') + '</p>' +
        '</div>';
    });
    dossierEl.innerHTML = dHtml;

    // ── Questions ──
    const questEl = document.getElementById('bac-questions');
    const totalPts = (q.questions || []).reduce((s, qst) => s + (qst.pts || 0), 0);
    let qHtml = '<div class="bac-q-header">Questions <span class="bac-pts-total">— ' + totalPts + ' pts au total</span></div>';
    (q.questions || []).forEach(qst => {
      qHtml += '<div class="bac-q-item">' +
        '<span class="bac-pts">' + qst.pts + ' pt' + (qst.pts > 1 ? 's' : '') + '</span>' +
        '<span>' + escHtml(qst.texte).replace(/\n/g, '<br>') + '</span>' +
        '</div>';
    });
    questEl.innerHTML = qHtml;

    // Réinitialiser réponse
    const ta = document.getElementById('bac-answer');
    if (ta) ta.value = '';
    const wc = document.getElementById('bac-wcount');
  ...
  function _tickTimer() {
    ...
    const val = document.getElementById('bac-timer-val');
    if (!val) return;
  ...
  // ── Soumettre / Copier pour correction ─────────────────────────
  function submitAnswer() {
    const q = _currentQ();
    if (!q) return;
    const answer = (document.getElementById('bac-answer') || {}).value || '';

    const bank = _currentBank();
    const label = subj === 'cbph' ? 'CBPH' : 'STSS';
    let prompt = '# Correction Bac ST2S — ' + label + '\n\n';
    prompt += '**Sujet :** ' + q.annee + ' — ' + q.theme + '\n\n';

    if (q.dossier && q.dossier.length > 0) {
      prompt += '## Dossier documentaire\n\n';
      q.dossier.forEach(doc => {
        prompt += '**' + doc.id + (doc.titre ? ' — ' + doc.titre : '') + '**\n';
        prompt += doc.texte + '\n\n';
      });
    }
    ...
    prompt += '## Questions\n\n';
    (q.questions || []).forEach(qst => {
      prompt += '- (' + qst.pts + ' pts) ' + qst.texte + '\n';
    });

    prompt += '\n## Réponse de l\'élève\n\n';
    prompt += answer || '*(pas de réponse)*';
    prompt += '\n\n---\n\n';
    prompt += 'Tu es un professeur de terminale ST2S exigeant et bienveillant. ';
    prompt += 'Corrige cette réponse avec la rigueur d\'un correcteur du baccalauréat : ';
    prompt += 'commence par une appréciation générale, puis commente chaque question (ce qui est bon, ';
    prompt += 'ce qui manque, les erreurs), et termine par une note sur ' +
      (q.questions || []).reduce((s, qst) => s + (qst.pts || 0), 0) + ' points justifiée.';

    // Copier dans le presse-papiers
    try {
      if (navigator.clipboard && window.isSecureContext) {
        navigator.clipboard.writeText(prompt).then(() => _showToast()).catch(() => _fallbackCopy(prompt));
      } else {
  ...
  function _fallbackCopy(text) {
    ...
    try { document.execCommand('copy'); _showToast(); } catch(e) { alert('Copier ce texte manuellement :\n\n' + text.slice(0, 500) + '…'); }
    document.body.removeChild(ta);
  }

  function _showToast() {
    const toast = document.getElementById('bac-toast');
    if (!toast) return;
    toast.style.opacity = '1'; toast.style.transform = 'translate(-50%, 0)';
    setTimeout(() => { toast.style.opacity = '0'; toast.style.transform = 'translate(-50%, 8px)'; }, 2800);
  }
  ...
  // ── API publique ────────────────────────────────────────────────
  return { init, switchSubject, switchChap, prevQ, nextQ, onInput, toggleTimer, submitAnswer };
